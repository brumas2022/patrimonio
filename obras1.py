...
def main():
        ...
        with t2:
           ...
           #col[0].write("***********************************************")
           col[0].markdown("***MEDICAO NRO***", text_alignmet="center")
           col[1].markdown("***DATA DA MEDIÇÃO***", text_alignmet="center")
           col[2].markdown("***VALOR DA MEDIÇÃO***", text_alignmet="center")
           #col[0].write("____")
           col[0].write("____")
           col[1].write("____")
           col[2].write("____")
           ...
           for post in response1.data:
               ...
               col[0].write("___")
               col[1].markdown(f"{post['datamedicao']}", text_alignmet="center")
               col[1].write("___")
               col[2].markdown(f"{post['valor']}", text_alignmet="center")
               col[2].write("___")
               #st.write("___")
