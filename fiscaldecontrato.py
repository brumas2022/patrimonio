...
def imprime_branco():
    ...
    # pdf.rect(x=70, y=70, w=60, h=8)
     ...
     pdf.text(11, 105, txt="DATA DO INICIO : ")
     pdf.text(11, 110, txt="DATA DA CONCLUSAO : ")
     pdf.text(11, 115, txt="PRAZO DO CONTRATO : ")
     pdf.text(121, 105, txt="VALOR DO CONTRATO : ")
     pdf.text(121, 110, txt="LICITACAO : ")
     pdf.text(121, 115, txt="RECURSO : ")
     ...
     pdf.text(11, 265, txt="FISCAL DE CONTRATO : ")
     pdf.rect(10, 268, 100, 8)
     pdf.text(11, 273, txt=f"PORTARIA N°")
     pdf.rect(10, 276, 100, 8)
     pdf.text(11, 281, txt=f"RELATORIO REFERENTE A :")
     ...
     pdf.output(f'C:/Users/Compras/Desktop/2025/RELATORIOS/CTR Embranco.pdf')    
...
def inicia_relatorio():
    ...
    # pdf.rect(x=70, y=70, w=60, h=8)
            ...
            #pdf.text(180, 50, txt=data_inicio)
            pdf.text(11, 60, txt="CONTRATADO(A)")
            pdf.text(51, 59, txt=nome_empresa[:60])
            pdf.text(51, 64, txt=nome_empresa[60:180])
            pdf.rect(10, 55, 40, 10)
            pdf.rect(50, 55, 150, 10)
            pdf.text(11, 73, txt="TERMO DO CONTRATO : ")
            ...
            pdf.text(11, 115, txt="PRAZO DO CONTRATO : "+f"{prazo} dias")
            ...
            #pdf.output(f"C:/Users/Compras/Desktop/2025/RELATORIOS/CTR {nro.replace("/", "-")} {empresa}.pdf") 
            # "C:/Users/Compras/Desktop/2025/RELATORIOS/
            #pdf.output(f'C:/Users/Compras/Desktop/2025/RELATORIOS/AGOSTO/CTR {nro.replace("/", "-") }.pdf') 
            pdf.output(f'C:/Users/marcos.brumatti/Desktop/2026/RELATORIOS/ABRIL/CTR {nro.replace("/", "-") }.pdf') 
