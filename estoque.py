...
def estoque_zero():
   ...
   df_zero=pd.read_excel("estoque-zero.xlsx", sheet_name=14)
...
def nad():
   ...
   st.dataframe(df_nad)
   df_ponto=pd.read_excel("https://docs.google.com/spreadsheets/d/1CcE0dc60ezKeIVTOlXOoM42UBDve46HI4GTSxIs_qY0/edit?gid=177221921#gid=177221921", sheet_name=1)
