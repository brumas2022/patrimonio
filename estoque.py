...
def estoque_zero():
   ...
   df_zero=pd.read_excel("estoque-zero.xlsx", sheet_name=19)
...
df=pd.read_excel("RPosicao_Estoque_Data_Atual_Excel.xlsx", sheet_name=33)
df1=pd.read_excel("RPosicao_Estoque_Data_Atual_Excel.xlsx", sheet_name=33)  ##para testes
