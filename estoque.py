...
def nad():
   ...
   df_new=df_nad.style.format(precision=0, thousands=".", decimal=",").highlight_between(subset=['entrega total', 'entrega prevista'], left="ok", right="MISS", color="red").format(subset="entrega prevista", na_rep="MISS")
