...
df=pd.read_excel("RPosicao_Estoque_Data_Atual_Excel.xlsx", sheet_name=19)
df1=pd.read_excel("RPosicao_Estoque_Data_Atual_Excel.xlsx", sheet_name=19)  ##para testes
