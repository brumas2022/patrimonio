...
def estoque_zero():
   ...
   df_zero=pd.read_excel("estoque-zero.xlsx", sheet_name=21)
...
df=pd.read_excel("RPosicao_Estoque_Data_Atual_Excel.xlsx", sheet_name=35)
df1=pd.read_excel("RPosicao_Estoque_Data_Atual_Excel.xlsx", sheet_name=35)  ##para testes
