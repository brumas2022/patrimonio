...
df=pd.read_excel("RPosicao_Estoque_Data_Atual_Excel.xlsx", sheet_name=13)
df1=pd.read_excel("RPosicao_Estoque_Data_Atual_Excel.xlsx", sheet_name=13)  ##para testes
