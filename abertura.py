...
g = col[2].link_button("teste1", "http://obras2.streamlit.app")
h = col[2].link_button("teste2", "http://obras2.streamlit.app")
i = col[2].link_button("teste3", "http://obras2.streamlit.app")
if d:
